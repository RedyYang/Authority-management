...
<%--										<c:forEach items="${role}" var="role">--%>
										<a href="${pageContext.request.contextPath}/role/addPermission.do?id=${role.id}&permissionId=${permission.id}" onclick="success()" class="btn bg-olive btn-xs">添加此资源权限</a>
<%--										</c:forEach>--%>
									</td>
